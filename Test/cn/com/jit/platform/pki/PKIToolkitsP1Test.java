...
import static cn.com.jit.platform.pki.SignHelper.assertSuccessSHA1P1Base64;
import static cn.com.jit.platform.pki.SignHelper.assertSuccessSHA256P1Base64;
import static org.junit.Assert.assertEquals;

import org.junit.Ignore;
import org.junit.Test;

public class PKIToolkitsP1Test extends BasePKIToolKitsTest {
	/*
	 * p1签名单元测试用例
	 */
	...
	public void should_return_success_without_base64() {
		// 测试执行
		 pkiTool.p1Sign(PRVKEY, PKIToolkits.DIGEST_SHA1, 0, PLAIN,handleResult);
		// 测试结果
		assertSuccessSHA1P1Base64(handleResult);
	}

	@Test
	public void should_return_success_digest_is_sha256_without_base64() {
		// 测试执行
		 pkiTool.p1Sign(PRVKEY, PKIToolkits.DIGEST_SHA256, 0, PLAIN,handleResult);
		// 测试结果
		assertSuccessSHA256P1Base64(handleResult);
	}

	@Test
	public void should_return_success_with_base64() {
		// 测试执行
		 pkiTool.p1Sign(PRVKEY, PKIToolkits.DIGEST_SHA1, 2, PLAINBASE,handleResult);
		// 测试结果
	...
	public void should_return_digest_is_null_with_base64() {
		// 测试执行
		 pkiTool.p1Sign(PRVKEY, null, FLAG_ATTACH_BASE64, PLAINBASE,handleResult);
		// 测试结果
		assertFailP1Sign(handleResult);
	}
	...
	public void should_return_password_is_empty_with_base64() {
		// 测试执行
		 pkiTool.p1Sign(PRVKEY, PKIToolkits.DIGEST_SHA1, FLAG_DETTACH, PLAIN,handleResult);
		// 测试结果
		assertFailP1Sign(handleResult);
	}
	...
	public void should_return_digest_is_empty_with_base64() {
		// 测试执行
		 pkiTool.p1Sign(PRVKEY, "", FLAG_DETTACH, PLAIN,handleResult);
		// 测试结果
		assertFailP1Sign(handleResult);
	}
	...
	public void should_return_plain_is_empty_with_base64() {
		// 测试执行
		 pkiTool.p1Sign(PRVKEY, PKIToolkits.DIGEST_SHA1, FLAG_DETTACH, "".getBytes(),handleResult);
		// 测试结果
		assertFailP1Sign(handleResult);
	}
	...
	public void should_return_fail_flag_is_7_without_base64() {
		// 测试执行
		 pkiTool.p1Sign(PRVKEY, PKIToolkits.DIGEST_SHA1, 7, PLAIN,handleResult);
		// 测试结果
		assertFailP1Sign(handleResult);
	}
	...
	public void should_return_flag_is_negtive_without_base64() {
		// 测试执行
		 pkiTool.p1Sign(PRVKEY, PKIToolkits.DIGEST_SHA1, -1, PLAIN,handleResult);
		// 测试结果
		assertFailP1Sign(handleResult);
	}
	...
	public void should_return_flag_is_base64_and_plain_is_not_base64() {
		// 测试执行
		 pkiTool.p1Sign(PRVKEY, PKIToolkits.DIGEST_SHA1, FLAG_ATTACH_BASE64, PLAIN,handleResult);
		// 测试结果
		assertFailP1Sign(handleResult);
	}
