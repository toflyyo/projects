...
public class PKIToolkitsP7AttachhSignSuccessTest extends BasePKIToolKitsTest {
	...
	public PKIToolkitsP7AttachhSignSuccessTest(byte[] privateKey,byte[] publicKeyCert,String digestArithmeticType, int flag, byte[] originalData,HandleResult out) {
		super();
	...
	public void testPkip7Sign() {
		...
		assertSuccessP7AttachSign(out,Base64.encode(out.resultData));
	}
}
